...
#define CATCH_REC_LIST1(f, x, peek, ...)                                       \
    ,                                                                          \
        f(x) CATCH_DEFER(                                                      \
            CATCH_REC_NEXT(peek, CATCH_REC_LIST0))(f, peek, __VA_ARGS__)
...
#define INTERNAL_CATCH_TYPE_GEN                                                \
    ...
    template<                                                                  \
        ...
        typename... E2,                                                        \
        typename... Rest>                                                      \
    constexpr auto append(L1<E1...>, L2<E2...>, Rest...) noexcept              \
        ->decltype(append(L1<E1..., E2...>{}, Rest{}...))                      \
    {                                                                          \
        return {};                                                             \
    }                                                                          \
    template<template<typename...> class L1, typename... E1, typename... Rest> \
    constexpr auto append(                                                     \
        L1<E1...>, TypeList<mpl_::na>, Rest...) noexcept->L1<E1...>            \
    {                                                                          \
        return {};                                                             \
    }                                                                          \
                                                                               \
    ...
    template<                                                                  \
        ...
        class... Elems,                                                        \
        typename... Elements>                                                  \
    constexpr auto rewrap(List<Elems...>, Elements...) noexcept                \
        ->decltype(append(                                                     \
    ...
    template<                                                                  \
        ...
        class... Containers,                                                   \
        typename... Types>                                                     \
    constexpr auto create(TypeList<Types...>) noexcept->decltype(append(       \
        Final<>{}, rewrap<Containers>(Types{}...)...))                         \
    {                                                                          \
        return {};                                                             \
    }                                                                          \
    template<                                                                  \
    ...
    constexpr auto convert(                                                    \
        List<Ts...>) noexcept->decltype(append(Final<>{}, TypeList<Ts>{}...))  \
    {                                                                          \
        return {};                                                             \
    }
...
#define INTERNAL_CATCH_NTTP_1(signature, ...)                                  \
    ...
    constexpr auto rewrap(List<__VA_ARGS__>, Elements... elems) noexcept       \
        ->decltype(append(                                                     \
            TypeList<Container<__VA_ARGS__>>{}, rewrap<Container>(elems...)))  \
    {                                                                          \
        return {};                                                             \
    }                                                                          \
    template<                                                                  \
...
#define INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD_2(                       \
    ...
    namespace {                                                                \
        ...
        {                                                                      \
            ...
            static int INTERNAL_CATCH_UNIQUE_NAME(globalRegistrar) = []() {    \
                using TestInit = decltype(convert<TestNameClass>(              \
                    std::declval<TmplList>()));                                \
                TestInit t;                                                    \
                t.reg_tests();                                                 \
                return 0;                                                      \
            }();                                                               \
...
#define CATCH_INTERNAL_ERROR(...)                                              \
    Catch::throw_logic_error(CATCH_MAKE_MSG(                                   \
        CATCH_INTERNAL_LINEINFO << ": Internal Catch2 error: "                 \
                                << __VA_ARGS__));
...
namespace Generators {
    ...
    template<typename T>
    typename std::
        enable_if<std::is_floating_point<T>::value, GeneratorWrapper<T>>::type
        random(T a, T b)
    {
        return GeneratorWrapper<T>(
            ...
            Estimator& estimator)
        {
            ...
            std::generate_n(
                ...
                [n, first, &estimator, &dist, &rng] {
                    ...
                    resampled.reserve(n);
                    std::generate_n(
                        std::back_inserter(resampled), n, [first, &dist, &rng] {
...
class RunContext : public IResultCapture, public IRunner {
  ...
  private:
    ...
    std::vector<MessageInfo> m_messages;
    std::vector<ScopedMessage> m_messageScopes; /* Keeps owners of so-called
                                                   unscoped messages. */
    ...
    namespace detail {
        ...
        class BasicResult : public ResultValueBase<T> {
          ...
          protected:
            ...
            std::string m_errorMessage;  // Only populated if resultType is an
                                         // error
            ...
            -> ParserResult
        {
            ...
            std::transform(
                srcLC.begin(), srcLC.end(), srcLC.begin(), [](char c) {
        ...
        struct BoundFlagLambda : BoundFlagRefBase {
            ...
            static_assert(
                ...
                "Supplied lambda must take exactly one argument");
            static_assert(
                std::is_same<typename UnaryLambdaTraits<L>::ArgType, bool>::
                    value,
...
GroupInfo::GroupInfo(
    ...
    std::size_t _groupsCount) :
    name(_name),
    groupIndex(_groupIndex), groupsCounts(_groupsCount)
{
}
...
AssertionStats::AssertionStats(
    ...
    infoMessages(_infoMessages), totals(_totals)
{
...
SectionStats::SectionStats(
    ...
    assertions(_assertions), durationInSeconds(_durationInSeconds),
...
TestCaseStats::TestCaseStats(
    ...
    bool _aborting) :
    testInfo(_testInfo),
    totals(_totals), stdOut(_stdOut), stdErr(_stdErr), aborting(_aborting)
{
}
...
TestGroupStats::TestGroupStats(
    ...
    totals(_totals), aborting(_aborting)
{
}
...
std::size_t listTests(Config const& config)
{
    ...
    if (!config.hasTestFilters())
        ...
        Catch::cout()
            << pluralise(matchedTestCases.size(), "matching test case") << '\n'
            << std::endl;
...
#pragma clang diagnostic pop
        ...
        std::string WithinUlpsMatcher::describe() const
        {
            ...
            if (m_type == FloatingPointKind::Double) {
                ...
                ret << step<float>(
                           static_cast<float>(m_target), -INFINITY, m_ulps)
                    << ", "
                    << step<float>(
                           static_cast<float>(m_target), INFINITY, m_ulps);
            }
...
MessageInfo::MessageInfo(
    ...
    lineInfo(_lineInfo), type(_type), sequence(++globalCount)
{
}
...
RedirectedStream::RedirectedStream(
    ...
    m_redirectionStream(redirectionStream), m_prevBuf(m_originalStream.rdbuf())
{
...
OutputRedirect::OutputRedirect(
    std::string& stdout_dest,
    std::string& stderr_dest) :
    m_originalStdout(dup(1)),
    m_originalStderr(dup(2)), m_stdoutDest(stdout_dest),
...
namespace Generators {
    struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
        ...
        {
            TrackerBase::close();
            // Generator interface only finds out if it has another item on
            // atual move
...
RunContext::RunContext(
    ...
    m_context(getCurrentMutableContext()), m_config(_config),
...
TestCaseInfo::TestCaseInfo(
    ...
    SourceLineInfo const& _lineInfo) :
    name(_name),
    className(_className), description(_description), lineInfo(_lineInfo),
    properties(None)
{
    setTags(*this, _tags);
}
...
namespace TestCaseTracking {
    ...
    bool SectionTracker::isComplete() const
    {
        ...
        if ((m_filters.empty() || m_filters[0] == "") ||
            std::find(
                m_filters.begin(), m_filters.end(), m_nameAndLocation.name) !=
                m_filters.end())
...
Version::Version(
    ...
    minorVersion(_minorVersion), patchNumber(_patchNumber),
    ...
    class ConsoleAssertionPrinter {
      public:
        ...
        ConsoleAssertionPrinter(
            ...
            bool _printInfoMessages) :
            stream(_stream),
            stats(_stats), result(_stats.assertionResult), colour(Colour::None),
...
{
    (*m_tablePrinter)
        << ColumnBreak() << Duration(stats.mean.point.count()) << ColumnBreak()
...
void XmlReporter::benchmarkStarting(BenchmarkInfo const& info)
{
    m_xml.writeAttribute("samples", info.samples)
        ...
        .writeAttribute(
            "clockResolution", static_cast<uint64_t>(info.clockResolution))
        .writeAttribute(
            "estimatedDuration", static_cast<uint64_t>(info.estimatedDuration))
